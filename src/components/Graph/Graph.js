...
class Graph extends Component {
	_consoleWarns() {
		...
		if (!component) {
			console.warn(
				'You must pass the name of the component to the `component` property.'
			);
			return true;
		}
		...
		if (!props) {
			console.warn(
				'It is mandatory to pass the data to the `props` property.'
			);
			return true;
		}
	...
	componentDidMount() {
		...
		if (typeof window !== 'undefined') {
			...
			this._chart = new Chart(
				props,
				this.refs[`clay-charts-${component}`]
			);
		}
	}

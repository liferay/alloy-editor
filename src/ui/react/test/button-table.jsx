(function() {
    ...
    describe('ButtonTableEdit', function() {
        ...
        it('should render just the table button when not in exclusive mode', function() {
            ...
            var editTable = TestUtils.scryRenderedDOMComponentsWithClass(buttonTable, 'container-edit-table');
        ...
        it('should show the table edit button when in exclusive mode', function() {
            ...
            var editTable = TestUtils.findRenderedDOMComponentWithClass(buttonTable, 'container-edit-table');

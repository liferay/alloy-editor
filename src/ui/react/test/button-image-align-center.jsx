(function() {
    ...
    describe('ButtonImageAlignCenter', function() {
        ...
        it('should apply styles for centering an image', function() {
            ...
            assert.strictEqual('block', testImageEl.getStyle('display'));
            assert.strictEqual('50%', testImageEl.getStyle('marginLeft'));

(function() {
    ...
    describe('ButtonLink', function() {
        ...
        it('should create link with specified http protocol', function() {
            bender.tools.selection.setWithHtml(this.nativeEditor, '{selection}');
            ...
            TestUtils.Simulate.change(inputLink, { target: { value: 'ftp://link.com' } });
            ...
            assert.strictEqual('<p><a href="ftp://link.com" target="">selection</a></p>', data);
        });

        it('should create link with editor linkSchema configuration', function() {
            bender.tools.selection.setWithHtml(this.nativeEditor, '{selection}');

            this.nativeEditor.config.linkSchema = 'file://';
            ...
            assert.strictEqual('<p><a href="file://link.com" target="">selection</a></p>', data);
        });

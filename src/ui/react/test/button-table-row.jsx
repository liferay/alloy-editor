(function() {
    ...
    describe('ButtonTableRow', function() {
        ...
        it('should render just the menu button when not expanded', function() {
            ...
            var dropdown = TestUtils.scryRenderedDOMComponentsWithClass(buttonTableRow, 'dropdown');
        ...
        it('should show a dropdown with the action buttons when expanded', function() {
            ...
            var dropdown = TestUtils.findRenderedDOMComponentWithClass(buttonTableRow, 'dropdown');

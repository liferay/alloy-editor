(function () {
    ...
    /**
     * The ToolbarFixed class hosts the buttons for styling a text selection.
     *
     * @class ToolbarFixed
     * @uses ToolbarButtons
     * @uses WidgetArrowBox
     ...
     * @uses WidgetPosition
     */
    var ToolbarFixed = createReactClass({
        ...
        render: function() {
            ...
            if (currentSelection) {
                ...
                var cssClasses = 'ae-toolbar-fixed ' + arrowBoxClasses;
                ...
                return (
                    <div aria-label="Fixed" className={cssClasses} data-tabindex={this.props.config.tabIndex || 0} onFocus={this.focus} onKeyDown={this.handleKey} role="toolbar" tabIndex="-1">
    ...
    AlloyEditor.Toolbars[ToolbarFixed.key] = AlloyEditor.ToolbarFixed = ToolbarFixed;
}());
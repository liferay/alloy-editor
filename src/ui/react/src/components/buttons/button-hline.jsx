(function () {
    ...
    var ButtonHline = React.createClass({
        ...
        render: function() {
            return (
                <button aria-label={AlloyEditor.Strings.horizontalrule} className="button" data-type="button-hline" onClick={this.execCommand} tabIndex={this.props.tabIndex} title={AlloyEditor.Strings.horizontalrule}>

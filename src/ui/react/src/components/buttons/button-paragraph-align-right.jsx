(function () {
    ...
    var ButtonParagraphAlignRight = React.createClass({
        ...
        render: function() {
            ...
            return (
                <button aria-label={this.props.label} aria-pressed={cssClass.indexOf('pressed') !== -1} className={cssClass} data-type="button-paragraph-align-right" onClick={this.applyStyle} tabIndex={this.props.tabIndex} title={this.props.label}>

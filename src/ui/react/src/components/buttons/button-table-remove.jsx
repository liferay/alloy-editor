(function () {
    ...
    var ButtonTableRemove = React.createClass({
        ...
        render: function() {
            return (
                <button aria-label={AlloyEditor.Strings.deleteTable} className="button" data-type="button-table-remove" onClick={this._removeTable} tabIndex={this.props.tabIndex} title={AlloyEditor.Strings.deleteTable}>

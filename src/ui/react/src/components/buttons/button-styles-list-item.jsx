(function () {
    ...
    var ButtonStylesListItem = React.createClass({
        ...
        render: function() {
            ...
            return (
                <button className="alloy-editor-toolbar-element" dangerouslySetInnerHTML={{__html: this._preview}} onClick={this._onClick} role="option" tabIndex={this.props.tabIndex}></button>
            );
        },

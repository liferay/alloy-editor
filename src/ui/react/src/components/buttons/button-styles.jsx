(function () {
    ...
    var ButtonStyles = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className="container-dropdown has-dropdown">
                    <button aria-expanded={this.props.expanded} aria-label={AlloyEditor.Strings.styles + ' ' + activeStyle} className="toolbar-element" onClick={this.props.toggleDropdown} role="combobox" tabIndex={this.props.tabIndex} title={AlloyEditor.Strings.styles + ' ' + activeStyle}>
                        <div className="container">
                            <span className="container-dropdown-selected-item">{activeStyle}</span>

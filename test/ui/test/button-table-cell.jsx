...
(function() {
    ...
    describe('ButtonTableCell', function() {
        ...
        it('should render just the menu button when not expanded', function() {
            ...
            var buttonTableCell = ReactDOM.render(<ButtonTableCell toggleDropdown={toggleDropdown} editor={this.editor} expanded={false} />, this.container);
        ...
        it('should show a dropdown with the action buttons when expanded', function() {
            ...
            var buttonTableCell = ReactDOM.render(<ButtonTableCell toggleDropdown={toggleDropdown} editor={this.editor} expanded={true} />, this.container);
        ...
        it('should insert a cell before the current one when clicking on the cellInsertBefore button', function() {
            ...
            var buttonDropdown = ReactDOM.render(<ButtonTableCell toggleDropdown={toggleDropdown} editor={this.editor} expanded={true} />, this.container);

...
describe('SelectionTest', function() {
	...
	describe('link', function() {
		...
		beforeEach(function() {
			...
			content +=
				'<p contenteditable="false"><a href="#" id="not-editable">Link</a></p>';
	...
	describe('image', function() {
		...
		beforeEach(function() {
			var content =
				'<img id="editable" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=">';
			content +=
				'<img id="noneditable" contenteditable="false"' +
		...
		it('should handle not image selection', function() {
			...
			var payload = getPayload.call(
				this,
				nativeEditor.element.findOne('#not-image')
			);
		...
		it('should check whether is editable', function() {
			...
			var payload = getPayload.call(
				this,
				nativeEditor.element.findOne('#not-editable')
			);
	...
	describe('text', function() {
		...
		beforeEach(function() {
			var content =
				'<p><span id="editable">Some editable text</span></p>';
			content +=
				'<p contenteditable="false"><span id="not-editable">Non editable</span></p>';
	...
	describe('table', function() {
		...
		beforeEach(function() {
			var content =
				'<table id="editable"><tr><td>Editable</td></tr><table>';
			content +=
				'<table id="not-editable" contenteditable="false"><tr><td>Not editable</td></tr><table>';
	...
	describe('embed', function() {
		...
		beforeEach(function() {
			var content =
				'<div id="embed" data-ae-embed-url="#" data-cke-widget-upcasted="1" data-widget="ae_embed" class="cke_widget_element">http//alloyeditor.com/demo/</div>';

			content +=
				'<div id="not_ae_embed" data-ae-embed-url="#" data-cke-widget-upcasted="1" data-widget="not_ae_embed" class="cke_widget_element">http//alloyeditor.com/demo/</div>';

import ButtonImageAlignCenter from '../../../src/components/buttons/button-image-align-center.jsx';
...
(function() {
	...
	describe('ButtonImageAlignCenter', function() {
		...
		it('should apply styles for centering an image', function() {
			...
			var buttonImageAlignCenter = ReactDOM.render(
				<ButtonImageAlignCenter editor={this.editor} />,
				this.container
			);
			...
			assert.strictEqual('auto', testImageEl.getStyle('marginLeft'));
			assert.strictEqual('auto', testImageEl.getStyle('marginRight'));
		});
		...
		it('should remove styles for centering an image when already centered', function() {
			bender.tools.selection.setWithHtml(
				this.nativeEditor,
				'A left aligned image: {<img style="display: block; margin-left: auto; margin-right: auto;" id="testImage" src="data:image/png;base64,">}.'
			);
			...
			assert.notOk(testImageEl.getStyle('marginRight'));
		});

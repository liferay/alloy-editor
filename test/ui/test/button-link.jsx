...
(function() {
    ...
    describe('ButtonLink', function() {
        ...
        it('should invoke requestExclusive when clicking on the button', function() {
            ...
            var buttonLink = ReactDOM.render(<ButtonLink editor={this.editor} requestExclusive={requestExclusiveListener} />, this.container);
        ...
        it('should invoke requestExclusive when pressing the keystroke [Ctrl|Cmd]+L', function() {
            ...
            ReactDOM.render(<ButtonLink editor={this.editor} requestExclusive={requestExclusiveListener} />, this.container);
